...
-- depends_on: {{ source('halcapitaldb', '_airbyte_raw_usercredits') }}
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['creditLimitProductId'], ['creditLimitProductId']) }} as creditlimitproductid,
...
from {{ source('halcapitaldb', '_airbyte_raw_usercredits') }} as table_alias
-- usercredits
where 1 = 1
